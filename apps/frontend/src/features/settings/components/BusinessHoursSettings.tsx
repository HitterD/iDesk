            ...
            <div className="glass-card p-6 space-y-4">
                ...
                <div className="flex gap-2">
                    ...
                    <button
                        ...
                        className="px-4 py-2 bg-primary text-primary-foreground rounded-xl font-medium hover:bg-primary/90 transition-colors disabled:opacity-50 flex items-center gap-2"
                    >
