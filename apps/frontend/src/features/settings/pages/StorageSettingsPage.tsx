        ...
        <div className="space-y-6">
            ...
            <Tabs.Root value={activeTab} onValueChange={setActiveTab} className="space-y-6">
                <Tabs.List className="flex gap-2 p-1 bg-slate-100 dark:bg-slate-800 rounded-xl w-fit">
                    <Tabs.Trigger
                        value="retention"
                        className="flex items-center gap-2 px-4 py-2 rounded-lg text-sm font-medium transition-all data-[state=active]:bg-white dark:data-[state=active]:bg-slate-700 data-[state=active]:text-primary data-[state=active]:shadow-sm text-slate-600 dark:text-slate-400 hover:text-slate-800 dark:hover:text-white"
                    >
