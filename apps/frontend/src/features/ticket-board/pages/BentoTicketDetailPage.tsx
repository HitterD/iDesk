...
export const BentoTicketDetailPage: React.FC = () => {
    ...
    const handleSendMessage = async (content: string, files?: FileList | null, isInternal: boolean = false) => {
        ...
        const optimisticMessage = {
            ...
            attachments: files ? Array.from(files).map((f, i) => ({
    ...
    return (
        <div className="flex flex-col h-full w-full bg-gray-100 dark:bg-slate-950 overflow-hidden">
            ...
            <button
                ...
                className="fixed bottom-4 right-4 p-2.5 glass-card-elevated hover:glass-shadow-medium hover:scale-105 transition-all z-40 group"
