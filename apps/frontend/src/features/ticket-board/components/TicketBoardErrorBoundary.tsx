                    ...
                    <div className="max-w-md w-full text-center">
                        ...
                        <div className="flex flex-col sm:flex-row items-center justify-center gap-3">
                            <button
                                ...
                                className="w-full sm:w-auto flex items-center justify-center gap-2 px-4 py-2.5 bg-gradient-to-r from-primary to-primary/90 text-slate-900 rounded-xl font-medium hover:from-primary/90 hover:to-primary/80 transition-all shadow-lg shadow-primary/20 hover:shadow-xl hover:shadow-primary/30"
                            >
                            ...
                            <button
                                ...
                                className="w-full sm:w-auto flex items-center justify-center gap-2 px-4 py-2.5 glass-card hover:bg-white/50 dark:hover:bg-slate-800/50 text-slate-600 dark:text-slate-300 font-medium rounded-xl transition-all"
                            >
