...
export const ActivityDrawerTrigger: React.FC<ActivityDrawerTriggerProps> = ({
    ...
    return (
        <button
            onClick={onClick}
            className="fixed right-6 bottom-20 p-3 glass-card-elevated hover:glass-shadow-medium hover:scale-105 transition-all z-40 group xl:hidden flex items-center gap-2"
