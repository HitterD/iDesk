        ...
        <SectionCard title="Informasi Request">
            <dl className="grid sm:grid-cols-2 gap-x-6 gap-y-4 text-sm">
                <div className="space-y-1">
                    <dt className="text-xs font-bold uppercase tracking-widest text-slate-400 dark:text-slate-500">Requester</dt>
                ...
                <div className="space-y-1">
                    <dt className="text-xs font-bold uppercase tracking-widest text-slate-400 dark:text-slate-500">Diajukan Pada</dt>
                    <dd className="font-semibold text-slate-900 dark:text-slate-200">{fmtDateTime(r.submittedAt)}</dd>
                </div>
                <div className="space-y-1 col-span-2">
                    <dt className="text-xs font-bold uppercase tracking-widest text-slate-400 dark:text-slate-500">Nama Penerima</dt>
                ...
                <div className="space-y-1 col-span-2 mt-2 pt-4 border-t border-slate-100 dark:border-slate-800">
                    <dt className="text-xs font-bold uppercase tracking-widest text-slate-400 dark:text-slate-500 mb-1">Justifikasi Kebutuhan</dt>
                ...
                {r.rejectReason && (
                    <div className="space-y-1 col-span-2 mt-2 p-3 rounded-xl bg-rose-50 dark:bg-rose-950/30 border border-rose-100 dark:border-rose-900/50">
                        <dt className="text-xs font-bold uppercase tracking-widest text-rose-500">Alasan Penolakan</dt>
