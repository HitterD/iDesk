        ...
        <SectionCard title="Catalog" action={
            ...
            <div className="grid grid-cols-2 sm:grid-cols-3 gap-3">
                {rows.map(c => (
                    ...
                    >
                        <div className="text-[9px] font-bold uppercase tracking-widest text-slate-400 dark:text-slate-500 group-hover:text-primary transition-colors">{c.category}</div>
                        ...
                        <div className="mt-0.5 text-[10px] text-slate-400 dark:text-slate-600 font-mono italic">{c.code}</div>
