    ...
    return (
        <div className="space-y-6">
            ...
            <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
                ...
                <Link
                    to="/client/create"
                    className="inline-flex items-center gap-2 px-5 py-2.5 bg-primary text-slate-900 rounded-xl hover:bg-primary/90 transition-all font-medium shadow-lg shadow-primary/20 hover:shadow-xl hover:shadow-primary/30 hover:-translate-y-0.5"
                >
                ...
                {filteredTickets.length === 0 ? (
                    <div className="p-12 text-center">
                        ...
                        {!hasActiveFilters && (
                            <Link
                                to="/client/create"
                                className="inline-flex items-center gap-2 px-5 py-2.5 bg-primary text-slate-900 rounded-xl hover:bg-primary/90 transition-all font-medium"
                            >
                                <Plus className="w-5 h-5" />
                                Create Ticket
                            </Link>
                                ...
                                return (
                                    ...
                                    >
                                        ...
                                        <div className="w-32 flex items-center justify-end gap-3">
                                            ...
                                            <ChevronRight className="hidden lg:block w-5 h-5 text-slate-300 dark:text-slate-600 group-hover:text-primary group-hover:translate-x-1 transition-all shrink-0" />
                                        </div>
                                    </div>
                                );
                            })}
