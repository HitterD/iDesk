...
export const BulkActionsBar: React.FC<BulkActionsBarProps> = ({
    ...
    return (
        <div className="fixed bottom-6 left-1/2 -translate-x-1/2 z-40 animate-fade-in-up">
            <div className="flex items-center gap-4 px-6 py-3 bg-slate-900 dark:bg-slate-800 rounded-full shadow-2xl border border-slate-700">
                {/* Count */}
                ...
                <Button
                    ...
                    className="text-white hover:text-green-400 hover:bg-green-900/30"
                >
                ...
                <Button
                    ...
                    onClick={onExport}
                    disabled={isProcessing}
                    className="text-white hover:text-blue-400 hover:bg-blue-900/30"
                >
