    ...
    return (
        <div ref={containerRef} className="relative">
            ...
            >
                ...
                <span className={`flex-1 text-left ${hasValue ? 'text-slate-800 dark:text-white' : 'text-slate-400'}`}>
                    {hasValue ? (
                        <>
            ...
            <AnimatePresence>
                {isOpen && (
                    <motion.div
                        ...
                        className="absolute top-full left-0 mt-2 w-72 overflow-hidden rounded-xl bg-gray-800/95 backdrop-blur-xl border border-white/10 shadow-xl z-[100]"
                    >
                        {/* Header */}
                        ...
                        {/* Selection hint */}
                        <div className="px-4 py-2 text-xs text-white/50 text-center border-b border-white/5">
                                ...
                                return (
                                    <button
                                        ...
                                        className={`
                                            ...
                                            transition-all
                                            ${!isCurrentMonth ? 'text-white/20' : 'text-white/80 hover:bg-white/10'}
                                            ${isToday && !isStart && !isEnd ? 'ring-1 ring-violet-500/50' : ''}
                                            ${isStart || isEnd ? 'bg-violet-500 text-white font-bold' : ''}
                        ...
                        <div className="flex items-center gap-2 px-3 py-2 border-t border-white/10">
                            <button
                                ...
                                className="flex-1 px-2 py-1.5 text-xs text-white/60 hover:text-white hover:bg-white/10 rounded-lg transition-colors"
                            >
                                Today
                            </button>
                            <button
