...
import { X, Save, LayoutDashboard, Ticket, Video, BookOpen, Bell, BarChart3, RefreshCw, DollarSign, Search, KeyRound, Users, Zap, Shield, Activity, Settings, Lock } from 'lucide-react';
