                ...
                <div className="p-6 space-y-5">
                    ...
                    <div className="flex gap-3 pt-2">
                        ...
                        <button
                            ...
                            className="flex-1 px-4 py-3 bg-gradient-to-r from-violet-600 to-purple-600 text-white font-bold rounded-xl hover:from-violet-700 hover:to-purple-700 transition-all flex items-center justify-center gap-2 disabled:opacity-50"
                        >
