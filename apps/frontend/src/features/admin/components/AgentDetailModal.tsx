...
import { X, User, Mail, Building, Shield, Ticket, CheckCircle, Clock, TrendingUp, AlertTriangle, Calendar, MessageSquare, ArrowUpRight, Activity, Phone, Briefcase, MapPin, Crown } from 'lucide-react';
