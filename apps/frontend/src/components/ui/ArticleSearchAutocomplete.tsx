        ...
        <div className={cn("relative", className)}>
            ...
            <div className="relative">
                ...
                <input
                    ...
                    autoFocus={autoFocus}
                    className="w-full h-12 pl-12 pr-10 bg-white dark:bg-slate-800 border border-slate-200 dark:border-slate-700 rounded-xl text-slate-800 dark:text-white placeholder:text-slate-400 focus:outline-none focus:ring-2 focus:ring-primary/50 focus:border-primary/50 transition-all"
                />
                {query && (
                    <button
                        onClick={() => {
