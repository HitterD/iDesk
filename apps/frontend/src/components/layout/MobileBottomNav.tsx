          ...
          if (item.highlight) {
            return (
              <NavLink
                key={item.path}
                to={item.path}
                className="relative -top-5 flex items-center justify-center w-14 h-14 bg-primary rounded-full shadow-lg shadow-primary/30 text-white hover:bg-primary/90 active:scale-95 transition-all"
