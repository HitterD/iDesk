...
const oracleTicket = { category: 'ORACLE_REQUEST', ticketType: TicketType.SERVICE } as Pick<Ticket, 'category' | 'ticketType'>;
const standardTicket = { category: 'GENERAL', ticketType: TicketType.SERVICE } as Pick<Ticket, 'category' | 'ticketType'>;
