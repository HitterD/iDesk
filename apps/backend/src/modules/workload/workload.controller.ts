...
export class WorkloadController {
    ...
    recalculateAgentWorkload(
        ...
        return this.workloadService.recalculateAgentWorkload(agentId, siteId);
    }
    ...
    autoAssignTicket(@Body() dto: AssignTicketDto) {
        return this.workloadService.autoAssignTicket(dto.ticketId);
    }
